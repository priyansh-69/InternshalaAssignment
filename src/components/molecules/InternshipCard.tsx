...
export function InternshipCard({ internship }: InternshipCardProps) {
  ...
  return (
    <Card className="w-full hover:shadow-xl hover:-translate-y-1.5 hover:border-blue-200 transition-all duration-300 bg-white border border-gray-100 rounded-2xl overflow-hidden group">
